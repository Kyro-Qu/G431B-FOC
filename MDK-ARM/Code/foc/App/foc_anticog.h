...
#define FOC_ANTICOG_POINTS 144U
...
typedef struct {
    float table[FOC_ANTICOG_POINTS];        /* 齿槽补偿电流 A（已去均值，144*4=576B） */
    uint16_t bin_count[FOC_ANTICOG_POINTS]; /* 标定期各桶样本数（144*2=288B，总仅864B，相比原来4KB减小78%） */
