...
/* 实机阻抗与电流环基线：
 * 原工程经过长跑验证通过的物理稳定参数：Rs=0.100Ω，Ls=20µH。
 * 此时在 2000 rad/s 设计带宽下 Kp=0.0400 V/A，Ki=200 V/(A·s)，
 * 该增益与 16kHz PWM 延迟完美匹配，成功稳定闭环跑到 9000 RPM 极速。
 * 若盲目把小信号方波注入辨识的高频视在电感（336µH）当作电流环设计参数，
 * 会把解耦项 we*Ls 放大 16.8 倍，在高速旋转时产生巨大的交叉对抗过冲触发过流。 */
#define FOC_M0_RS_OHM           0.100f     /* 相电阻 Ω */
#define FOC_M0_LS_H             0.000020f  /* 动态等效相电感 H (20 µH) */
