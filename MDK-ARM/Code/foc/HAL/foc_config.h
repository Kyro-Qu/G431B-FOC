...
/* 实机 ident 辨识值：静态升压测得 Rs≈0.437Ω，高频方波注入测得视在电感 Ls≈336µH
 * （原 0.10Ω / 20µH 为 ST 历史工程占位符，严重偏离实物 16 倍，导致电流环实际带宽严重缩水）。 */
#define FOC_M0_RS_OHM           0.437f     /* 相电阻 Ω */
#define FOC_M0_LS_H             0.000336f  /* 相电感 H (336 µH) */
